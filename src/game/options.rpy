...
define config.name = _("魔理沙与爱丽丝的曲奇KISS")
...
define gui.about = _p("""
    仅供学习使用. 非已有版权部分采用GPLv3授权

    作者: 夜雀; 制作日期: 2021年11月21日; 版本0.1

    使用的相关素材及鸣谢: (等待补充)

    作者PGP公钥指纹: B813E6593E057341B361663529341C25E6B20F3A (游戏目录下存放着一份公钥)
""")
...
define config.save_directory = "cookie"
